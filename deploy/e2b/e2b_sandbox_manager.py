...
class E2BSandboxManager:
    ...
    async def _bootstrap_services(self, sandbox: Sandbox) -> Dict[str, Any]:
        ...
        try:
            ...
            local_nginx_conf = os.path.join(repo_dir, "e2b-mcp-template", "mcp", "nginx.conf")
        ...
        repo_dir = os.path.dirname(os.path.abspath(__file__))
        local_startup = os.path.join(repo_dir, "e2b-mcp-template", "mcp", "startup.sh")
        local_wrapper = os.path.join(repo_dir, "e2b-mcp-template", "mcp", "chrome-devtools-wrapper.sh")
        local_servers = os.path.join(repo_dir, "e2b-mcp-template", "mcp", "servers.json")
